...
export const BUILTIN_DEFAULTS: Record<string, PrintTemplateConfig> = {
  '销售出库': {
    ...
    // 表头：2 列网格（与 sampleOutbound.Tb 字段一一对应）
    headerFields: [
      { key: '单据编号', title: '单据编号', left: 12, top: 22, fontSize: 9, width: 330, bold: false, align: 'left', showLabel: true, section: 'header' },
      { key: '客户', title: '客户', left: 350, top: 22, fontSize: 9, width: 330, bold: false, align: 'left', showLabel: true, section: 'header' },
      { key: '仓库', title: '仓库', left: 12, top: 38, fontSize: 9, width: 330, bold: false, align: 'left', showLabel: true, section: 'header' },
      { key: '业务员', title: '业务员', left: 350, top: 38, fontSize: 9, width: 330, bold: false, align: 'left', showLabel: true, section: 'header' },
      { key: '日期', title: '日期', left: 12, top: 54, fontSize: 9, width: 330, bold: false, align: 'left', showLabel: true, section: 'header' },
      { key: '备注', title: '备注', left: 350, top: 54, fontSize: 9, width: 330, bold: false, align: 'left', showLabel: true, section: 'header' },
    ],
    // 明细：与 sampleOutbound.TbDetail 字段一一对应
    detailColumns: [
      { key: '货品编码', title: '编码', width: 80, align: 'center', visible: true, type: 'String' },
      { key: '货品名称', title: '名称', width: 150, align: 'center', visible: true, type: 'String' },
      { key: '规格', title: '规格', width: 110, align: 'center', visible: true, type: 'String' },
      ...
      { key: '单价', title: '单价', width: 60, align: 'center', visible: true, type: 'Decimal' },
      { key: '金额', title: '金额', width: 70, align: 'center', visible: true, type: 'Decimal' },
    ],
    freeElements: [
      { type: 'text', left: 12, top: 250, width: 200, height: 12, content: '签字：', fontSize: 9, section: 'footer' },
    ],
    summaryRows: [],
    tableLeft: 10,
    tableTop: 64,
